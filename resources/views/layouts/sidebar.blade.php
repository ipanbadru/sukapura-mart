<div class="relative bg-violet-600 min-h-screen w-64 hidden md:block">
    <div class="flex flex-col items-center mt-5 mb-3 px-3">
        <img src="{{ asset('img/logo.png') }}" alt="Logo" class="w-28 mx-auto">
        <h1
            class="bg-white block w-full shadow-xl text-violet-600 px-4 py-2 tracking-widest text-xl text-center font-semibold rounded-md mt-2">{{ config('app.name') }}</h1>
    </div>
