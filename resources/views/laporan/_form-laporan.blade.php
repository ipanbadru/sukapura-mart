        ...
        <div class="w-full flex justify-end items-end">
            <div class="w-2/5 mr-2">
                ...
                <input type="date" name="tgl" id="tgl"
                    class="shadow rounded-md border-gray-300 w-full focus:outline-none focus:border-blue-600 focus:ring focus:ring-blue-300"
                    value="{{ request('tgl') ? request('tgl') : '' }}" required>
            </div>
            <div class="mb-0.5">
                <x-button color="indigo"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<template x-if="data === 'mingguan'">
    <div class="w-1/2" x-data="{ date : '{{ request('tgl_mulai') }}'}">
        <div class="flex justify-end w-full items-end">
            ...
            <div class="w-2/5 mr-2 ml-6">
                ...
                <input type="date" name="tgl_akhir" id="tgl_akhir"
                    x-model="formatDate(new Date(date).addDays(7))"
                    readonly
    ...
    <div class="w-1/2">
        <div class="flex justify-end w-full items-end">
            <div class="w-2/5">
                ...
                <x-select name="bulan" id="bulan" required>
                    <option value=""></option>
            ...
            <div class="w-2/5 mr-2 ml-6">
                ...
                <x-select name="tahun" id="tahun" required>
                    <option value=""></option>
